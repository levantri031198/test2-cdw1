...
Route::get('/flight-list', [
  'uses' => 'FlightController@searchFlights',
  'as' => 'searchFlight'
]);
...
Route::get('/flight-detail/{flight_id}', [
  'uses' => 'FlightController@detailsFlights',
  'as' => 'flightDetail'
]);
...
Route::get('/flight-book/{flight}', [
  'uses' => 'Auth\UserController@bookingFlights',
  'as' => 'flightBooking'
]);

Route::post('/booking', 'BookingController@bookingFlights')->name('booking');
